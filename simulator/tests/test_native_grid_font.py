...
class NativeGridFontTests(unittest.TestCase):
    ...
    def test_bind_scales_reader_only_from_16px_native_grid(self) -> None:
        ...
        self.assertIn("kChromeSmallPx = kLogicalCellPx * kChromeSmallScale", policy)
        self.assertIn("kChromeUi10Px = kLogicalCellPx * kChromeUi10Scale", policy)
        self.assertIn("kChromeUi12Px = kLogicalCellPx * kChromeUi12Scale", policy)
