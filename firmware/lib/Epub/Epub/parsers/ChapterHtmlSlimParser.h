...
class ChapterHtmlSlimParser {
  ...
  int headerUntilDepth = INT_MAX;  // set when inside h1-h6, used to suppress <br> in headings
  ...
  int8_t wordSpacing;
  bool chinesePunctFullWidth;  // true = Chinese punctuation rendered at full char width
  bool showImages;  // true = load and display images, false = skip images
 ...
 public:
  explicit ChapterHtmlSlimParser(std::shared_ptr<Epub> epub, const std::string& filepath, GfxRenderer& renderer, const int fontId,
      ...
      : epub(epub),
        ...
        chinesePunctFullWidth(chinesePunctFullWidth),
